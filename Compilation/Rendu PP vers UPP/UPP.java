...
class UPPFalse extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
                    return new RTLCte(reg, 0, succ); // 0 comme false
        //To do
    }//toRTL
...
class UPPNot extends UPPUnOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
                    ...
                    return e.toRTL(locals, globals, regE, not); // no using xor
        //To do
    }//toRTL
...
class UPPCond extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, RTLInst succ) {
                    PRegister condReg = cond.getPRegister(locals);

                    RTLInst rIst1 = i1.toRTL(locals, globals, succ);
                    RTLInst rIst2 = i2.toRTL(locals, globals, succ);
                    RTLGtz gtz = new RTLGtz(condReg, rIst1, rIst2);

                    RTLInst rCond = cond.toRTL(locals, globals, condReg, gtz);
                    return rCond;
        //To do
    }//toRTL
...
class UPPProcCall extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, RTLInst succ) {
                    ArrayList<PRegister> regs = new ArrayList<PRegister>(); 
                    for(Pair<String,PRegister> arg: locals)
                    {
                        regs.add(arg.right);
                    }
                    return new RTLProcCall(callee, regs, succ);
        //To do
    }//toRTL
...
class UPPSeq extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, RTLInst succ) {
                    RTLInst rChildInst = i2.toRTL(locals, globals, succ);
                    RTLInst rParenInst = i1.toRTL(locals, globals, rChildInst);
                    return rParenInst;
        //To do
    }//toRTL        
