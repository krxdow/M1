...
class PPInv extends PPUnOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ie = e.toUPP(locals);
        return new UPPSub(new UPPCte(0), ie);
    }//toUPP
...
class PPLt extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        ...
        UPPExpr lte1 = e1.toUPP(locals);
        UPPExpr lte2 = e1.toUPP(locals);
        return new UPPLt(lte1, lte2);
    }//toUPP
...
class PPLe extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr lee1 = e1.toUPP(locals);
        UPPExpr lee2 = e1.toUPP(locals);
        return  new UPPLt(lee1,lee2);
    }//toUPP
...
class PPEq extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr eqe1 = e1.toUPP(locals);
        UPPExpr eqe2  =e2.toUPP(locals);
        return new UPPEq(eqe1,eqe2);
    }//toUPP
...
class PPGt extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr gt1 = e1.toUPP(locals);
        UPPExpr gt2 = e2.toUPP(locals);
        return  new UPPGt(gt1,gt2);
    }//toUPP
...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        ...
        return new UPPLoad(new UPPAdd(narr, new UPPMul(nindex, new UPPCte(4))));
    }//toUPP
